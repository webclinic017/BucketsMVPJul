...
function FeaturesBlocks() {
  return (
    <section className="relative">
      ...
      <div
        className="absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-gray-700 pointer-events-none"
        aria-hidden="true"
      ></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20 bg-white">
            <h2 className="sm: text-3xl text-gray-700 font-bold m-5 md:text-5xl text-gray-700 font-bold m-5">
              How Buckets works
            </h2>
            <p className="text-2xl text-gray-600">
              Buy investment baskets created by you or experts within a few
              clicks at no cost, with securities bought directly in to your
              brokerage account
            </p>
          </div>
            ...
            <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
              ...
              <Link to="/create-bucket">
                <div className="relative flex flex-col items-center p-6 bg-tuscany-400 rounded shadow-xl">
                  ...
                  <p className="text-gray-700 text-center">
                    Real time risk return metrics generated so you can invest
                    with confidence
                  </p>
                </div>
              </Link>
