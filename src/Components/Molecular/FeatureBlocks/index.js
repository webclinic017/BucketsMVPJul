...
function FeaturesBlocks() {
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-bpurple-500 pointer-events-none" aria-hidden="true"></div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <Link to="/home">
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">The on stop shop for diversification and new ideas</p>
              </div>
            </Link>
            ...
            <Link to="/create-bucket">
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">Its as simple as creating a playlist of songs or a to-do list</p>
              </div>
            </Link>
            ...
            <Link to="/create-bucket">
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">Real time risk return metrics generated so you can invest with confidence</p>
              </div>
            </Link>
            ...
            <Link to="/create-bucket">
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">Share your masterpiece with friends and buy each other's baskets</p>
              </div>
            </Link>
            ...
            <Link to="/create-bucket">
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">Connect your brokerage account and securities will be bought directly in it</p>
              </div>
            </Link>
            ...
            <Link to="/create-bucket">
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">Buy once a month or once a quarter into your system</p>
              </div>
            </Link>
