...
const EditableStockRow = ({
  stockName,
  onChangeStockName,
  onStockPercentIncrement,
  onStockPercentDecrement,
  logoUrl,
  stockPercent,
  onStockSelect,
  suggestions,
    ...
    <div key={rowIndex} className="flex items-center justify-between mt-4">
      <div className="flex items-center">
        <img
          ...
          className="mr-4 h-14 w-14 object-contain ml-2"
        />
        <DropdownInput
          value={stockName}
      ...
      <div className="flex items-center justify-between">
        <img
          onClick={onStockPercentDecrement}
        ...
        <img
          onClick={onStockPercentIncrement}
          className="w-5 h-5 object-contain cursor-pointer"
          src={PlusIcon}
        />
        <img
          className="w-4 h-4 object-contain ml-6 cursor-pointer -mt-1"
          onClick={handleOnClickDelete}
          src={hover ? trash_red : trash_grey}
