...
const Login = (props) => {
  ...
  const onGoogleLogin = (userInfo) => {
    const data = {
      ...
      firstName: userInfo.givenName ? userInfo.givenName : "",
      lastName: userInfo.familyName ? userInfo.familyName : "",
    ...
    <>
      ...
      <div class="w-full flex flex-wrap ">
        ...
        <div class="w-1/2 shadow-2xl">
          <img
            class="object-scale-down object-cover w-full h-screen hidden md:block"
            src={gif1}
          />
        </div>
      </div>
