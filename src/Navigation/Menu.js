    ...
    >
      <div className="menu-item pt-2 px-3">
        <img
          ...
          src={CloseIcon}
          className="w-5 h-5 bg-white cursor-pointer rounded-full ml-auto"
        />
      </div>
      <Link
        id="home"
        ...
        className={`menu-item pt-2 text-xl pl-4 ${
      ...
      {user && isAuthenticated && (
        <Link
          ...
          to="/my-buckets"
          onClick={handleOnMenuItemClick}
          className={`menu-item pt-4 text-xl pl-4 ${
            location.pathname === "/my-buckets" && "font-bold"
          } ${
            location.pathname === "/my-buckets"
              ? "text-green-600"
              : "text-white"
          }`}
        >
      ...
      <Link
        ...
        onClick={handleOnMenuItemClick}
        className={`menu-item pt-4 text-xl pl-4 ${
          location.pathname === "/create-bucket" && "font-bold"
        } ${
          location.pathname === "/create-bucket"
            ? "text-green-600"
            : "text-white"
        }`}
      >
      ...
      {!user && !isAuthenticated && (
        <Link
          ...
          className={`menu-item pt-4 text-xl pl-4 ${
            ...
            location.pathname === "/login" ? "text-green-600" : "text-white"
          }`}
        >
          Login
        </Link>
      ...
      {user && isAuthenticated && (
        <Link
          ...
          } ${location.pathname === "/home" ? "text-green-600" : "text-white"}`}
        >
          Expert Buckets
        </Link>
      )}
      ...
      {user && isAuthenticated && (
        <Link
          ...
          className={`menu-item pt-4 text-xl pl-4 ${
            ...
            location.pathname === "/settings" ? "text-green-600" : "text-white"
          }`}
        >
          Settings
        </Link>
